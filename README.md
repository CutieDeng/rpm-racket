...
--rpm-system openeuler2203 --rpm-release 2 --rpm-arch x86_64
--rpm-system openeuler2203 --rpm-release 2 --rpm-arch arm64
--rpm-system openeuler2403 --rpm-release 2 --rpm-arch x86_64
...
scripts/verify-rpm.sh \
  --rpm /path/to/artifacts/racket9-9.3.1-2.2.cached.fc40.aarch64.rpm \
  --rpm-system fc40 \
  --rpm-release 2 \
  --rpm-arch arm64 \
  --cache-mode cached
...
Install only the matching `racket9-fc40.repo`
...
```sh
dnf --disablerepo=cutiedeng-racket-fc40-cached \
    --enablerepo=cutiedeng-racket-fc40-postinstall \
